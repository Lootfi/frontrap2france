<div class="container r2f-section-seven r2f-section-gap">
    <div class="row">
        <div class="col-lg-4 pb-4 pb-lg-0">
            <h2 class="r2f-border-left mb-4 pl-2 fw-bold ">Gaming</h2>
        ...
        <div class="col-lg-4 pb-4 pb-lg-0">
            <h2 class="r2f-border-left mb-4 pl-2 fw-bold">Art et Culture</h2>
        ...
        <div class="col-lg-4">
            <div class="r2f-last-element p-4 bg-dark">
                <h2 class="r2f-border-left text-white mb-4 pl-2 fw-bold">Projets qu'on kiff</h2>
