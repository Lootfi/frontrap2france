...
(function($) {
    ...
    $(window).on("load", function() {
        if (window.location.pathname == "/") {
            feature_slider_3.owlCarousel({
                ...
                autoplayHoverPause: true,
                navText: [
                    '<i class="feather icon-arrow-left"></i><span>Prev Post</span>',
                    '<i class="feather icon-arrow-right"></i><span>Next Post</span>'
                ],
                items: 2,
                autoplay: false,
                animateIn: "fadeInLeft",
    ...
    if (window.location.pathname == "/") {
        ...
        if (video_slider.length > 0) {
            video_slider.slick({
                ...
                arrows: true,
                nextArrow:
                    '<button class="slick-next"><i class="feather icon-chevron-right"></i></button>',
                prevArrow:
                    '<button class="slick-prev"><i class="feather icon-chevron-left"></i></button>',
                centerPadding: "30px",
                responsive: [
                    {
                        breakpoint: 992,
        ...
        if (feature_slider_active.length > 0) {
            ...
            $(".feature_item_slide").on("afterChange", function(
                event,
                slick,
                currentSlide,
                nextSlide
    ...
    if ($("#myVideo").length > 0) {
        $("#playVideo").on("click", function(e) {
            ...
            if ($(this).hasClass("playing")) {
                ...
                $(this)
                    .addClass("playing")
                    .html('<i class="feather icon-pause"></i>');
                vid.play();
            }
        });
    }
    ...
    if ($(".row").length > 0) {
        $(".menu_popup ul li.menu-item-has-children > a").on("click", function(
            e
        ) {
            e.preventDefault();
            if (
    ...
    $(window).on("load resize", function(e) {
        if ($(window).width() < 991) {
            ...
            $(".mobile_menu ul li.menu-item-has-children").each(function() {
                var $this = $(this);
                $this.append(
                    '<span class="submenu_toggler"><i class="feather icon-chevron-down"></i></span>'
                );
            });
            $(
                ...
                if ($(this).hasClass("active-span")) {
                    $("i", $this)
                        .removeClass("feather icon-chevron-up")
                        .addClass("feather icon-chevron-down");
                } else {
                    $("i", $this)
                        .addClass("feather icon-chevron-up")
                        .removeClass("feather icon-chevron-down");
                }

                $(this)
                    .prev("ul.sub-menu, .megamenu, .megamenu_2")
                    .slideToggle();
